...
| P0 | Install Trivy Operator | Vulnerability, config, RBAC, infra, compliance, and SBOM reports reach Sutra and correlate to workloads | Never ingest Secret or ConfigMap contents |
