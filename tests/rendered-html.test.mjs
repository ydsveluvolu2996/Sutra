...
test("server-renders an authentication gate without leaking protected route data", async () => {
  const routes = ["/dashboard", "/customers", "/cmdb", "/cmdb/resource?key=demo", "/changes", "/findings", "/iac-scan", "/security-events", "/cases", "/compliance", "/compliance-frameworks", "/costs", "/reports", "/controls", "/roadmap", "/onboard", "/kubernetes/fleet", "/kubernetes/attack-paths", "/kubernetes/issues", "/kubernetes/permissions", "/kubernetes/iam", "/kubernetes/trends", "/kubernetes/vulnerability-updates", "/kubernetes/vulnerability-management", "/kubernetes/drift", "/settings"];
