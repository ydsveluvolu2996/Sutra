...
test("native report renders hierarchy, budgeted/actual/forecast, honest status, history and evidence", async () => {
  ...
  try {
    ...
    const dashboard = {
      ...
      coverage: { totalAwsBudgets: 1, matchedAwsBudgets: 1, budgetsWithActual: 1, budgetsWithForecast: 1, organizationWideBudgets: 0, linkedAccountBudgets: 1, unresolvedBudgets: 0, mappedAccounts: 1, missingHierarchyAccounts: 0, missingTaxonomyAccounts: 0, currencies: ["USD"], budgetLevels: ["BusinessUnit"] },
      budgets: [{ budget, targeting: "linked_accounts", accountMappings: [{ accountId: ACCOUNT_A, accountName: "Platform", parentId: "ou-platform", ouPath: ["Root", "Platform"], company: "Sutra", businessUnit: "Platform", environment: "production", costCenter: "CC-1", owner: "finops", coverage: "complete" }], unmappedAccountIds: [], mappingCoverage: "complete" }], nextCursor: null,
