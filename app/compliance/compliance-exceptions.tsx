...
export function ComplianceExceptions({
  ...
  return (
    <section className={`panel ${styles.panel}`}>
      ...
      {payload?.permissions.localSingleAdminReview ? <div className={styles.notice}><strong>Single-reviewer governance:</strong> this workspace has one active administrator, so self-review is recorded explicitly in the audit trail. Add a second administrator to establish separation of duties.</div> : null}
