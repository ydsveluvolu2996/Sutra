...
export function ExecutiveReportBrowser() {
  ...
  const readinessEvidenceMissing = assessment === null || complianceError !== null;
  const readinessOutcome = readinessEvidenceMissing || coverageGaps.length > 0 || assessment.summary.unknown > 0
