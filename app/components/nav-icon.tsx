...
const KEY_ICON: Partial<Record<NavKey, IconName>> = {
  ...
  kubernetes_vulnerability_management: "bug",
...
const KEY_TONE: Partial<Record<NavKey, NavTone>> = {
  ...
  kubernetes_vulnerability_management: "orange",
  ...
  findings: "orange",
  vulnerabilities: "red",
  network_exposure: "orange",
  iac_scan: "violet",
  security_events: "red",
  cases_routing: "blue",
  cases: "amber",
  compliance: "green",
  compliance_frameworks: "green",
  controls: "blue",
  reports: "violet",
  costs: "amber",
  operations: "cyan",
