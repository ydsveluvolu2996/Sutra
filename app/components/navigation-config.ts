...
export const navGroups: readonly NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "kubernetes_inventory", label: "Inventory", href: "/kubernetes/inventory", icon: "IN", capabilities: readConnection },
      { key: "kubernetes_security", label: "Security findings", href: "/kubernetes/security", icon: "SF", capabilities: readConnection },
    ],
    sections: [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "report_builder", label: "Report builder", href: "/reports/builder", icon: "RB", capabilities: readConnection },
    ],
  },
  {
    key: "finops",
