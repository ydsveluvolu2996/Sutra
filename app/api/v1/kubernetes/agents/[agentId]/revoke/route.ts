...
export async function POST(
  ...
  try {
    ...
    if (typeof body !== "object" || body === null || Array.isArray(body)) {
      throw Object.assign(new Error("Invalid revocation request"), { code: "INVALID_INPUT" });
    }
    ...
    await new KubernetesAgentRepository().revoke({
    ...
    return jsonResponse({
      schema: "sutra.kubernetes-agent-revocation.v1",
      agentId,
      status: "revoked",
    });
  } catch (error) {
