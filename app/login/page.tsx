        ...
        <ul className="auth-assurances" aria-label="Security properties">
          <li>
            ...
            {identityMode === "password"
              ...
              : "Credentials are handled only by this protected workspace"}
          </li>
        ...
        <div className="auth-form-card">
          {waiting ? (
            <div className="auth-loading" role="status">
              ...
              <strong>Checking your workspace</strong>
            ...
            <>
              <div className="auth-heading">
                ...
                <p>This one-time action creates the organization, owner identity and protected session.</p>
              </div>
              <form className="auth-form" onSubmit={(event) => void submitBootstrap(event)}>
                <label>
                  ...
                  />
                  <small>Use the one-time token generated by the workspace setup process.</small>
                </label>
            ...
            <>
              <div className="auth-heading">
                ...
                <h2>Sign in to Sutra</h2>
                <p>Use the organization identity provisioned for this workspace.</p>
              </div>
